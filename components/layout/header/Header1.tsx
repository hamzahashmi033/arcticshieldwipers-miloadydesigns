          ...
          <div className="container-fluid">
            <div className="text-header-info">
              ...
              <Link className="email-head text-white" href="#">
                ...
                <span className="d-none d-lg-inline-block">
                  sale@arcticshieldwipers.com
                </span>
              </Link>
            </div>
            <div className="text-header">
              <div className=" text-sm-medium text-white">
                More than <span className="text-primary">800+</span>
                special collection of product
              </div>
              <Link
          ...
          <div className="main-header">
            <div className="header-left">
              <div className="header-logo">
                <Link className="d-flex p-4" href="/">
                  <img
                ...
                <nav className="nav-main-menu">
                  <ul className="main-menu">
                    ...
                    <li className="has-children arrow-white">
                      ...
                      <ul className="sub-menu">
                        <li>
                          <Link href="/">Arctic Shield Wipers</Link>
                        </li>
                        <li>
              ...
              <div className="header-right">
                <div className="d-none d-xxl-inline-block align-middle mr-15">
                  ...
                  <Link className="btn btn-signin bg-white text-dark" href="/">
                    Your Cart
                  </Link>
                </div>
