      ...
      <footer className="footer">
        <div className="container">
          ...
          <div className="row d-flex justify-content-between">
            <div className="col-xl-3 col-md-6 col-sm-12  footer-1">
              <div className="mt-20 mb-20">
                <Link className="d-flex" href="/">
                  <img
                    className="light-mode p-2"
                    alt="Carento"
                    src="/assets/imgs/template/logo1.png"
					width={200}
                  />
                ...
                <div className="box-info-contact mt-0">
                  ...
                  <p className="text-md neutral-400 icon-email">
                    support@arcticshieldwipers.com
                  </p>
                </div>
            ...
            <div className="col-xl-3 col-md-6 col-sm-12 d-flex flex-column   footer-2">
            ...
            <div className="col-xl-3 col-md-6 col-sm-12 d-flex flex-column  footer-3">
              <h6 className="text-linear-3">Our Categories</h6>
              <ul className="menu-footer">
                <li>
                  <Link href="#">Winter Wiper Protectors</Link>
                </li>
                <li>
                  <Link href="#">Winter Gloves</Link>
                </li>
                <li>
                  <Link href="#">Ice Scrapers</Link>
                </li>
                <li>
            ...
            <div className="col-xl-3 col-md-6 col-sm-12 d-flex flex-column  footer-4">
              <h6 className="text-linear-3">Terms & Policy</h6>
              <ul className="menu-footer">
                <li>
            ...
            <div className="row align-items-center justify-content-center">
              <div className="col-md-6 text-md-start text-center mb-20">
                <p className="text-sm color-white">
                  © {new Date().getFullYear()} Arctic Shield Wiper Inc. All rights reserved.
                </p>
              </div>
