				...
				<div className="container">
					<div className="row align-items-end">
						<div className="col-md-9 wow fadeInUp">
							<h3 className="title-svg neutral-1000 mb-5">Our Trending Products</h3>
							<p className="text-lg-medium text-bold neutral-500">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Placeat, vero.</p>
						</div>
								...
								<div className="swiper-wrapper">
									...
									<div className="card-journey-small background-card hover-up">
											<div className="card-image">
												<Link href="/">
													<img src="/assets/imgs/cars-listing/cars-listing-1/1-4.png" alt="Carento" />
												</Link>
											</div>
											<div className="card-info">
												...
												<div className="card-title"><Link className="heading-6 neutral-1000" href="/">Arctic Shields Wiper</Link></div>
												<div className="card-program">
													<div className="card-location">
														<p className=" text-md-medium neutral-500">Arctic Sheild</p>
													</div>
													...
													<div className="endtime">
														...
														<div className="card-button"><Link className="btn btn-gray" href="/">Purchase Now</Link></div>
													</div>
												</div>
											</div>
										</div>
