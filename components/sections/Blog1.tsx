          ...
          <div className="row align-items-end">
            <div className="col-md-9 mb-30 wow fadeInUp">
              ...
              <p className="text-lg-medium text-bold neutral-500">
                ...
                Provident, possimus voluptatibus. Eaque minima nulla quis
                officiis quas sint dolorem, dignissimos voluptatibus nam ex
                sapiente qui pariatur harum corporis soluta ad!
              </p>
            </div>
